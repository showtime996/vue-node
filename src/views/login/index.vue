  ...
  <div class="login-form">
    <el-card class="box-card" style="width: 30vw; background-color: rgba(255, 255, 255, 0.9); border-width: 0px;" :body-style="{ padding: '40px' }">
      <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()">
        <el-row>
          <h3 class="title">To Be Number One</h3>
          <el-col :span="24">
    ...
    <li>
        ...
        <a href="http://www.beian.gov.cn" target="_blank">浙公网安备 33052302000854号</a>
    </li>
    <li>
        <a href="http://beian.miit.gov.cn/" target="_blank">浙ICP备2020033531号</a>
    </li>
</ul>
  </div>
</div>
...
.login-form {
  ...
  align-items: center;
  height: 100vh;
  background: url(~@/assets/img/login.jpg) no-repeat 50%, #000;
  background-size: 100%;
